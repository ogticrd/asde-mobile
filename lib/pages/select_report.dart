              ...
              Expanded(
                child: OutlinedButton(
                  ...
                  child: Column(
                    mainAxisAlignment: MainAxisAlignment.center,
                    children: [
                      Image.asset("assets/urban_cleaning_icon.png"),
                      Text(
                        "Aseo Urbano",
                        textAlign: TextAlign.center,
                      ),
          ...
          child: Row(
            children: [
              ...
              Expanded(
                child: OutlinedButton(
                  style: OutlinedButton.styleFrom(
                    backgroundColor: (_value == "Espacios Públicos"
                        ? Colors.lightBlue[50]
                        : Colors.white),
                    shape: RoundedRectangleBorder(
                      borderRadius: BorderRadius.circular(10.0),
              ...
              Expanded(
                child: OutlinedButton(
                  style: OutlinedButton.styleFrom(
                    backgroundColor: (_value == "Protección Animal"
                        ? Colors.lightBlue[50]
                        : Colors.white),
                    shape: RoundedRectangleBorder(
                      borderRadius: BorderRadius.circular(10.0),
                  ...
                  child: Column(
                    mainAxisAlignment: MainAxisAlignment.center,
                    children: [
                      Image.asset("assets/animal_protection_icon.png"),
